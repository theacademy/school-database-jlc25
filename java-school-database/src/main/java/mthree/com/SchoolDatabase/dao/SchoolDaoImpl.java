    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<Course> csCourses() {
        ...
        // YOUR CODE STARTS HERE
         ...
         String sql = "SELECT c.courseCode, c.courseDesc FROM course c JOIN teacher t ON c.teacherId = t.tid WHERE t.dept = 'Computer Science';";
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT c.courseCode, c.courseDesc, COUNT(*) AS numStudents FROM course c JOIN course_student cs ON c.cid = cs.course_id GROUP BY (cs.course_id);";
